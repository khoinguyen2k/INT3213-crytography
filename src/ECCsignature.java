...
public class ECCsignature {
   ...
   public static void main(String[] args) throws NoSuchAlgorithmException {
      ...
      //Q = dg
      BigInteger[] Q = ElipticCurve.multiplyPoint(g, d, p, a);
      ...
      BigInteger[] kg = ElipticCurve.multiplyPoint(g, k, p, a);
      ...
      while (r.equals(BigInteger.ZERO) || s.equals(BigInteger.ZERO) || ElipticCurve.isInfinityPoint(kg)) {
         k = randomBigInteger(p.bitLength());
         kg = ElipticCurve.multiplyPoint(g, k, p, a);
         x1 = kg[0];
         r = x1.mod(n);
      ...
      BigInteger[] u1g = ElipticCurve.multiplyPoint(g, u1, p, a);
      BigInteger[] u2Q = ElipticCurve.multiplyPoint(Q, u2, p, a);

      //u1 * g + u2 * Q = (x0, y0)
      BigInteger[] u1gAddu2Q = ElipticCurve.addPoints(u1g, u2Q, p, a);
